        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Sign in to continue listening', style: TextStyle(color: AppTheme.textSecondary)),
              const SizedBox(height: 24),
              ...
              FilledButton(
                ...
                child: state.loading ? const SizedBox(height: 22, width: 22, child: CircularProgressIndicator(strokeWidth: 2)) : const Text('Login'),
              ),
              const SizedBox(height: 12),
              TextButton(
