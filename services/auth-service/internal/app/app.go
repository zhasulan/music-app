...
import (
	...
	"github.com/freedom-music/auth-service/internal/config"
	"github.com/freedom-music/auth-service/internal/handler"
...
func (a *Application) Run() error {
	...
	go func() {
		a.logger.Info("auth-service listening", zap.Int("port", a.cfg.HTTPPort))
