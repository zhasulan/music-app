...
import (
	...
	"github.com/freedom-music/events-service/internal/config"
	"github.com/freedom-music/events-service/internal/handler"
...
func (a *Application) Run() error {
	...
	go func() {
		a.logger.Info("events-service listening", zap.Int("port", a.cfg.HTTPPort))
