...
import (
	...
	"github.com/freedom-music/library-service/internal/config"
	"github.com/freedom-music/library-service/internal/handler"
...
func New() (*Application, error) {
	...
	svc := service.NewLibraryService(repo, catalogClient)
...
func (a *Application) Run() error {
	...
	go func() {
		a.logger.Info("library-service listening", zap.Int("port", a.cfg.HTTPPort))
