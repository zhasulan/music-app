...
import (
	...
	"github.com/freedom-music/recommendation-service/internal/config"
	"github.com/freedom-music/recommendation-service/internal/handler"
...
func New() (*Application, error) {
	...
	catalog := client.NewCatalogClient(cfg.CatalogServiceURL)
...
func (a *Application) Run() error {
	...
	go func() {
		a.logger.Info("recommendation-service listening", zap.Int("port", a.cfg.HTTPPort))
