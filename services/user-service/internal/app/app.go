...
import (
	...
	"github.com/freedom-music/user-service/internal/config"
	"github.com/freedom-music/user-service/internal/handler"
...
func (a *Application) Run() error {
	...
	go func() {
		a.logger.Info("user-service listening", zap.Int("port", a.cfg.HTTPPort))
